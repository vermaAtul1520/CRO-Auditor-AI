...
// async function generatePPT(auditData) {
//   console.log('Generating PowerPoint report...');
...
//   titleSlide.addText('CRO AUDIT REPORT', {
//     x: 1, y: 2, w: 8, h: 1.5,
//     fontSize: 44, bold: true, color: 'FFFFFF',
//     align: 'center'
//   });

//   titleSlide.addText(`${new URL(auditData.url).hostname}`, {
//     x: 1, y: 3.5, w: 8, h: 0.8,
...
//   summarySlide.addText(`Website: ${auditData.url}`, {
//     x: 0.5, y: 1.5, w: 9, h: 0.4,
//     fontSize: 14, color: colors.text
//   });

//   summarySlide.addText(`Load Time: ${auditData.scrapedData.loadTime}ms`, {
//     x: 0.5, y: 2, w: 9, h: 0.4,
//     fontSize: 14, color: colors.text
//   });

//   summarySlide.addText(`Analysis Date: ${new Date(auditData.createdAt).toLocaleDateString()}`, {
...
//     `Images: ${auditData.scrapedData.images.length}`
//   ];

//   summarySlide.addText(metrics.join('\n'), {
//     x: 0.5, y: 3.5, w: 4, h: 2,
//     fontSize: 12, color: colors.text
//   });

//   // Slide 3: First Impressions
//   await addSectionSlide(pptx, 'First Impressions', auditData.auditResults.firstImpressions, colors);

//   // Slide 4: Call-to-Actions
//   await addSectionSlide(pptx, 'Call-to-Actions', auditData.auditResults.callToActions, colors);

//   // Slide 5: UX/Layout/Speed
//   await addSectionSlide(pptx, 'UX/Layout/Speed', auditData.auditResults.uxLayoutSpeed, colors);

//   // Slide 6: Trust Signals  
//   await addSectionSlide(pptx, 'Trust Signals', auditData.auditResults.trustSignals, colors);

//   // Slide 7: Mobile Responsiveness
//   await addSectionSlide(pptx, 'Mobile Responsiveness', auditData.auditResults.mobileResponsiveness, colors);

//   // Slide 8: Screenshots
//   const screenshotSlide = pptx.addSlide();
//   screenshotSlide.addText('Website Screenshots', {
//     x: 0.5, y: 0.5, w: 9, h: 0.8,
//     fontSize: 28, bold: true, color: colors.primary
//   });
...
//   let yPos = 1.5;
//   for (const screenshot of auditData.scrapedData.screenshots.slice(0, 2)) {
...
//           path: screenshotPath,
//           x: 0.5, y: yPos, w: 4, h: 2.5
//         });

//         screenshotSlide.addText(screenshot.description, {
//           x: 5, y: yPos, w: 4, h: 0.5,
//           fontSize: 12, color: colors.text
//         });

//         yPos += 3;
//       } catch (error) {
//         console.log(`Could not add screenshot: ${error.message}`);
//       }
//     }
//   }

//   // Final Slide: Recommendations Summary
//   const finalSlide = pptx.addSlide();
//   finalSlide.addText('Key Recommendations', {
//     x: 0.5, y: 0.5, w: 9, h: 0.8,
//     fontSize: 28, bold: true, color: colors.primary
//   });
...
//     '• Test different layouts for higher conversions'
//   ];

//   finalSlide.addText(recommendations.join('\n'), {
//     x: 0.5, y: 1.5, w: 9, h: 4,
...
//   const filename = `CRO-Audit-${new URL(auditData.url).hostname}-${Date.now()}.pptx`;
//   const filepath = path.join(__dirname, 'reports', filename);

//   await pptx.writeFile({ fileName: filepath });

//   console.log(`PowerPoint report generated: ${filename}`);
//   return filepath;
// }

// async function addSectionSlide(pptx, title, content, colors) {
